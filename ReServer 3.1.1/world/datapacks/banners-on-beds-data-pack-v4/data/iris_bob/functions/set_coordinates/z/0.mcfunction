...
execute if score $within_524288 iris matches 0 positioned ~ ~ ~0.524288 run function iris_bob:set_coordinates/z/1
execute if score $within_524288 iris matches 1 run function iris_bob:set_coordinates/z/1
