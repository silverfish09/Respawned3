...
execute if data storage iris_bob:data {ShortestDistanceAxis: "x"} run function iris_bob:find_next_block/x
execute if data storage iris_bob:data {ShortestDistanceAxis: "y"} run function iris_bob:find_next_block/y
execute if data storage iris_bob:data {ShortestDistanceAxis: "z"} run function iris_bob:find_next_block/z