# Get x position of the intersection (useful for iris_bob:find_closest_surface/ray_intersects_with_surface)
...
execute if score $y_intersection iris >= $y0 iris if score $y_intersection iris <= $y1 iris if score $z_intersection iris >= $z0 iris if score $z_intersection iris <= $z1 iris run function iris_bob:find_closest_surface/ray_intersects_with_surface