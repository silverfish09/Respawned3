#> iris_bob:find_closest_surface/ray_intersects_with_surface
#
...
#
# @within iris_bob:find_closest_surface/bottom/find_intersection
# @within iris_bob:find_closest_surface/east/find_intersection
# @within iris_bob:find_closest_surface/north/find_intersection
# @within iris_bob:find_closest_surface/south/find_intersection
# @within iris_bob:find_closest_surface/top/find_intersection
# @within iris_bob:find_closest_surface/west/find_intersection
...
data modify storage iris_bob:data ContactSurface set from storage iris_bob:data List[-1]