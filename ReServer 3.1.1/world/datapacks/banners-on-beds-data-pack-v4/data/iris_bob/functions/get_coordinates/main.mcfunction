...
# @within iris_bob:get_targeted_block
# @output
#	score $[x] iris
...
execute as @e[type=minecraft:marker, tag=iris.get_coordinates, limit=1] run function iris_bob:get_coordinates/as_marker