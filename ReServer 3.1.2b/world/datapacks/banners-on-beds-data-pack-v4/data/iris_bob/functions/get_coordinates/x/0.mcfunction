...
# @within iris_bob:get_coordinates/as_marker
...
execute if score $get_coordinates.within_524288 iris matches 0 positioned ~0.524288 ~ ~ run function iris_bob:get_coordinates/x/1
execute if score $get_coordinates.within_524288 iris matches 1 run function iris_bob:get_coordinates/x/1