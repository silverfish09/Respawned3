# This function gets the fractional part of the z coordinate, executed as an area effect cloud by iris_bob:get_coordinates/as_marker
...
execute if score $get_coordinates.within_524288 iris matches 0 positioned ~ ~ ~0.524288 run function iris_bob:get_coordinates/z/1
execute if score $get_coordinates.within_524288 iris matches 1 run function iris_bob:get_coordinates/z/1
