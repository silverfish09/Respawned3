...
execute if block ~ ~ ~ #minecraft:beds[facing=west] run function bob:mark_bed_as_occupied/west
execute if block ~ ~ ~ #minecraft:beds[facing=north] run function bob:mark_bed_as_occupied/north
execute if block ~ ~ ~ #minecraft:beds[facing=east] run function bob:mark_bed_as_occupied/east
execute if block ~ ~ ~ #minecraft:beds[facing=south] run function bob:mark_bed_as_occupied/south

summon minecraft:area_effect_cloud ~ ~ ~ {Tags: ["bob", "bob.occupied_bed"], Duration: 2147483647}